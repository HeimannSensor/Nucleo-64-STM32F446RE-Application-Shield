...
class TwoWire : public Stream {
  private:
    ...
    static uint16_t rxBufferAllocated;	// dennis: uint8_t -> uint16_t
    static uint16_t rxBufferIndex;		// dennis: uint8_t -> uint16_t
    static uint16_t rxBufferLength;		// dennis: uint8_t -> uint16_t
    ...
    static void allocateRxBuffer(uint16_t length);
